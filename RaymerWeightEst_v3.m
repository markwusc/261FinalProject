...
% Empirical correction: +4% on Raymer EWF based on Kodiak vs generic GA data.
% Apply to both single- and twin-engine configs since both are STOL.
STOL_penalty = 1.04;    % multiplicative correction on EWF  [-]

% --- Fuel reserve ---
fuel_reserve = 0.05;     % 5% additional reserve over mission fuel  [-]
